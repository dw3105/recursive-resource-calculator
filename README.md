...
+ edit machines quickly: picker windows for modules, machines and beacons, one pick filling an empty slot row, a click placing the module in hand, and the pipette key copying and pasting modules, machine setups and beacon groups;
